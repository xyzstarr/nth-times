...
(function() {
  ...
  //var app = angular.module('nth.app', ['formly', 'ngAria', 'ngAnimate', 'ngMaterial']);
    // var app = angular.module('nth.app', ['formlyMaterial', 'formlyConfig', 'ngMessages', 'formly', 'ngAria', 'ngAnimate', 'ngMaterial']);
  var app = angular.module('nth.app', ['formlyMaterial', 'ngMessages','ngAria', 'ngAnimate', 'ngMaterial']);
